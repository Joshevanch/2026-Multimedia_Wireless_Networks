...
- [2. Course Outline](#2-course-outline)
  ...
  - [2.4. Assignments](#24-assignments)
    - [Grading criteria — the same for every assignment](#grading-criteria--the-same-for-every-assignment)
...
2. **Research** & **presentation** skills practice through 4 assignments and a final project:
   background study notes → ns-3 setup → literature review → baseline reproduction → your own modification.
...
A **presentation week has no lecture** — the session belongs to the students. Every deliverable is
due **08:00 A.M. on the morning of its presentation**, in your GitHub repository.

Five presentations: **A1** (Week 4, 5 min) · **A2** (Week 7, 10 min) · **A3** (Week 11, 10 min) ·
**A4** (Week 13, 15 min) · **Final Project** (Weeks 15–16, 20 min), each followed by Q&A.

The four assignments form one chain — the topic you propose in Week 4 is the one whose
modification you defend in Week 15 or 16.

| Week                   | Date  | Core Topic                                                                                         |
|:---------------------- |:----- |:-------------------------------------------------------------------------------------------------- |
| **Week 1**             | 9/8   | [Opening]() — Introduction and Environment Setup                                                   |
| **Week 2**             | 9/15  | QoS Fundamentals                                                                                   |
| **Week 3**             | 9/22  | QoS Mechanisms 1                                                                                   |
| **Week 4**             | 9/29  | **A1 presentation** (5 min) *hyperlink template                                                    |
| **Week 5**             | 10/6  | QoS Mechanisms 2                                                                                   |
| **Week 6**             | 10/13 | QoS Mechanisms 3                                                                                   |
| **Week 7**             | 10/20 | **A2 presentation** (10 min) *hyperlink template                                                   |
| **Week 8**             | 10/27 | WiFi MAC                                                                                           |
| **Week 9**             | 11/3  | 802.11e Enhanced Distributed Channel Access (EDCA) 1                                               |
| **Week 10**            | 11/10 | 802.11e Enhanced Distributed Channel Access (EDCA) 2                                               |
| **Week 11**            | 11/17 | **A3 presentation** (10 min) *hyperlink template                                                   |
| **Week 12**            | 11/24 | 802.11e Enhanced Distributed Channel Access (EDCA) 3                                               |
| **Week 13**            | 12/1  | **A4 presentation** (15 min) *hyperlink template                                                   |
| **Week 14**            | 12/8  | 5G QoS                                                                                             |
...
> [!NOTE]
> **Two paths.** Choose one in A1 and keep it to the end. The assignments, the deadlines and the
> grading criteria are identical on both — only the topic and the final presentation week differ.
>
> 1. **Basic — reproduce 802.11e.** Work from the assigned paper on 802.11e EDCA:
>    <https://ieeexplore.ieee.org/document/1265851>. Everything you need is covered by the
>    Week 8–12 lectures. Final presentation in **Week 15**.
> 2. **Advanced — bring your own topic.** NTN, 5G, newer WiFi (802.11ax / 802.11be), or another
>    QoS problem you care about — a thesis topic is welcome. You choose the paper and the
>    simulator (ns-3 WiFi / ns-3 NTN / OAI 5G). Final presentation in **Week 16**.

## 2.3. Evaluation

Two options. They differ only in whether there is a **midterm exam** — the schedule, the
assignments and the [grading criteria](#grading-criteria--the-same-for-every-assignment) are
identical in both.

**Option A — with midterm exam** *(held in Week 8, 10/27)*

| Component                                                    | What it measures                                          | Weight   |
| :----------------------------------------------------------- | :--------------------------------------------------------- | -------: |
| Q&A / class participation                                     | Weekly, up to 15 pts (1 pt/week)                            | **15%**  |
| [A1 — Background Study Notes](#a1--background-study-notes)    | Presentation skill, paper reading, first project proposal   | **10%**  |
| [A2 — ns-3 Setup & First Scenario](#a2--ns-3-setup--first-scenario) | ns-3 installed and a scenario on your topic running    | **10%**  |
| [A3 — Literature Review](#a3--literature-review)              | Papers studied, system model, revised proposal              | **10%**  |
| [A4 — Baseline Reproduction](#a4--baseline-reproduction)      | Reproducing the paper's result in ns-3                      | **15%**  |
| **Midterm Exam (Week 8)**                                     | QoS Fundamentals and QoS Mechanisms (Weeks 2–6)             | **20%**  |
| [Final Project](#final-project--your-modification)            | Your modification, results, and final report                | **20%**  |
| **Total**                                                     |                                                             | **100%** |
...
| Q&A / class participation                                     | Weekly, up to 15 pts (1 pt/week)                            | **15%**  |
| [A1 — Background Study Notes](#a1--background-study-notes)    | Presentation skill, paper reading, first project proposal   | **10%**  |
| [A2 — ns-3 Setup & First Scenario](#a2--ns-3-setup--first-scenario) | ns-3 installed and a scenario on your topic running    | **15%**  |
| [A3 — Literature Review](#a3--literature-review)              | Papers studied, system model, revised proposal              | **15%**  |
| [A4 — Baseline Reproduction](#a4--baseline-reproduction)      | Reproducing the paper's result in ns-3                      | **20%**  |
| [Final Project](#final-project--your-modification)            | Your modification, results, and final report                | **25%**  |
| **Total**                                                     |                                                             | **100%** |

> [!NOTE]
> Under **Option A** the exam shares the **Week 8** session with the WiFi MAC lecture — Week 8 is
> the first slot after QoS Mechanisms finishes in Week 6, and the schedule has no dedicated exam
> week.
...
Four assignments plus a final project, one per presentation week. Each deliverable is due
**08:00 A.M. on the morning of its presentation** and lives in your own
`MWN-2026-[student ID]-[English Name]` GitHub repository.

| Assignment                                                    | Due & presented   | Time   |
| :------------------------------------------------------------ | :---------------- | :----- |
| [A1 — Background Study Notes](#a1--background-study-notes)     | Week 4 · 9/29     | 5 min  |
| [A2 — ns-3 Setup & First Scenario](#a2--ns-3-setup--first-scenario) | Week 7 · 10/20 | 10 min |
| [A3 — Literature Review](#a3--literature-review)               | Week 11 · 11/17   | 10 min |
| [A4 — Baseline Reproduction](#a4--baseline-reproduction)       | Week 13 · 12/1    | 15 min |
| [Final Project](#final-project--your-modification)             | Week 15 *(basic)* / Week 16 *(advanced)* | 20 min |

### Grading criteria — the same for every assignment

* **50% Documents**
  * **30% Study Notes** — Markdown files in your GitHub repository.
  * **20% Rehearsal Presentation** — record yourself presenting your slides with
    [PowerPoint Speaker Coach](https://support.microsoft.com/en-us/powerpoint/rehearse-your-slide-show-with-speaker-coach),
    have an LLM review the recording and your slides, and include the feedback in your repository.
* **50% Presentation & Q&A** — the live session.

> [!IMPORTANT]
> **Everything lives in your GitHub repository.** Push your work **every week**, not in one upload
> at the deadline. The commit history is part of the submission: it should show the work
> developing week by week.

### A1 — Background Study Notes

**Week 4 · 9/29, due 08:00 A.M. — presented 5 min**

* **Purpose:** Build the shared toolkit — how to present, how to read a paper — and put your first
  project idea on the table.
* **Tasks:** write a study note on each of:
  ...
  3. **Your project proposal** — which path you are taking (basic or advanced), the problem, and
     what you would measure. It is a first draft; you revise it in A3.
...
* **Tasks:**
  ...
  * Pick **one simple scenario** related to your chosen topic and run it — for the basic path this
    means a minimal 802.11e/EDCA setup; for the advanced path, the smallest scenario that touches
    your topic.
  * Show a result from your own run: a throughput or delay number, a trace, a PCAP opened in
    Wireshark. Anything that proves the simulator is yours and running.

### A3 — Literature Review

**Week 11 · 11/17, due 08:00 A.M. — presented 10 min**

* **Purpose:** Study the papers behind your topic and turn them into an experiment you could run.
* **Tasks:**
  * Select **1–3 IEEE papers** on your topic. For the basic path, the assigned 802.11e paper is
    the starting point.
  * For each paper, write down:
    * **Problem, Importance, Challenges**
    * **System Model** — Environment, Inputs, Outputs, Performance Metrics
    * **Experimental Results** — the ns-3 settings needed to reproduce them (topology, traffic
      model, PHY/MAC parameters, simulation time, seeds)
  * **Revise your project proposal** from A1 in light of what you read — state explicitly what
    changed and why.
...
* **Tasks:**
  * Choose **one result** from your paper and reproduce it in ns-3 — same figure, same axes,
    plotted against the original where possible.
  * Explain the differences. A curve that does not match is a result too, as long as you can say
    *why*: parameter mismatch, unmodelled effect, different traffic model, too few runs.
...
* **Tasks:**
  * Start from your A4 baseline and **add a modification** — a different traffic model, a
    different channel model, another scenario, a parameter policy, a protocol tweak. One
    well-evaluated change is worth more than three half-finished ones.
  * Evaluate it against the baseline on the metrics you defined in A3.
  * Submit the **final report** (Markdown, in your repository): problem and motivation, related
    work, system model, ns-3 setup, baseline reproduction, your modification, results, limitations.
